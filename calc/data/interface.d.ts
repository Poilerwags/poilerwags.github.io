...
export type Weather = 'Sand' | 'Sun' | 'Rain' | 'Hail' | 'Snow' | 'Darkness' | 'Harsh Sunshine' | 'Heavy Rain' | 'Strong Winds';
...
export type TypeName = 'Normal' | 'Fighting' | 'Flying' | 'Poison' | 'Ground' | 'Rock' | 'Bug' | 'Ghost' | 'Steel' | 'Fire' | 'Water' | 'Grass' | 'Electric' | 'Psychic' | 'Ice' | 'Dragon' | 'Dark' | 'Fairy' | 'Crystal' | '???';
