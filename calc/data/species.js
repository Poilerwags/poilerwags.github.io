...
var XY_PATCH = {
    ...
    Aggron: { otherFormes: ['Aggron-Mega', 'Aggron-Delta'] },
    ...
    Bellossom: { bs: { df: 95 } },
    Blastoise: { otherFormes: ['Blastoise-Mega', 'Blastoise-Delta', 'Blastoise-Delta-Mega'] },
    Blaziken: { otherFormes: ['Blaziken-Mega', 'Blaziken-Delta'] },
    Butterfree: { bs: { sa: 90 } },
    Camerupt: { otherFormes: ['Camerupt-Mega', 'Camerupt-Delta', 'Camerupt-Delta-Mega'] },
    Charizard: { otherFormes: [
            'Charizard-Mega-X', 'Charizard-Mega-Y', 'Charizard-Delta', 'Charizard-Delta-Mega',
        ] },
    ...
    Exploud: { bs: { sd: 73 } },
    Gallade: { otherFormes: ['Gallade-Mega', 'Gallade-Delta', 'Gallade-Delta-Mega'] },
    Garchomp: { otherFormes: ['Garchomp-Mega'] },
    Gardevoir: { types: ['Psychic', 'Fairy'], otherFormes: [
            'Gardevoir-Mega', 'Gardevoir-Delta', 'Gardevoir-Delta-Mega',
        ] },
    Gengar: { otherFormes: ['Gengar-Mega'] },
    Gigalith: { bs: { sd: 80 } },
    Glalie: { otherFormes: ['Glalie-Mega', 'Glalie-Delta', 'Glalie-Delta-Mega'] },
    Golem: { bs: { at: 120 }, otherFormes: ['Golem-Delta'] },
    ...
    Kirlia: { types: ['Psychic', 'Fairy'], otherFormes: ['Kirlia-Delta'] },
    Krookodile: { bs: { df: 80 } },
    Kyogre: { otherFormes: ['Kyogre-Primal'] },
    Latias: { otherFormes: ['Latias-Mega'] },
    Latios: { otherFormes: ['Latios-Mega'] },
    Leavanny: { bs: { sd: 80 }, otherFormes: ['Leavanny-Armor'] },
    Lopunny: { otherFormes: ['Lopunny-Mega', 'Lopunny-Delta', 'Lopunny-Delta-Mega'] },
    Lucario: { otherFormes: ['Lucario-Mega', 'Lucario-Delta', 'Lucario-Delta-Mega'] },
    Manectric: { otherFormes: ['Manectric-Mega'] },
    Marill: { types: ['Water', 'Fairy'] },
    Mawile: { types: ['Steel', 'Fairy'], otherFormes: [
            'Mawile-Mega', 'Mawile-Delta', 'Mawile-Delta-Mega',
        ] },
    Medicham: { otherFormes: ['Medicham-Mega', 'Medicham-Delta', 'Medicham-Delta-Mega'] },
    Metagross: { otherFormes: [
            'Metagross-Mega',
            'Metagross-Delta-S',
    ...
    Mewtwo: { otherFormes: [
            'Mewtwo-Mega-X', 'Mewtwo-Mega-Y', 'Mewtwo-Shadow', 'Mewtwo-Shadow-Mega', 'Mewtwo-Armor',
        ] },
    'Mime Jr.': { types: ['Psychic', 'Fairy'] },
    'Mr. Mime': { types: ['Psychic', 'Fairy'] },
    Nidoking: { bs: { at: 102 } },
    Nidoqueen: { bs: { at: 92 } },
    Pidgeot: { bs: { sp: 101 }, otherFormes: ['Pidgeot-Mega', 'Pidgeot-Delta', 'Pidgeot-Delta-Mega'] },
    Pikachu: {
        bs: { df: 40, sd: 50 },
        otherFormes: [
            'Pikachu-Belle',
    ...
    Raichu: { bs: { sp: 110 }, otherFormes: ['Raichu-Delta'] },
    Ralts: { types: ['Psychic', 'Fairy'], otherFormes: ['Ralts-Delta'] },
    Rayquaza: { otherFormes: ['Rayquaza-Mega'] },
    Roserade: { bs: { df: 65 }, otherFormes: ['Roserade-Delta'] },
    Sableye: { otherFormes: ['Sableye-Mega', 'Sableye-Delta', 'Sableye-Delta-Mega'] },
    Salamence: { otherFormes: ['Salamence-Mega'] },
    Sceptile: { otherFormes: ['Sceptile-Mega', 'Sceptile-Delta'] },
    Scizor: { otherFormes: ['Scizor-Mega', 'Scizor-Delta', 'Scizor-Delta-Mega'] },
    Scolipede: { bs: { at: 100 }, otherFormes: ['Scolipede-Delta'] },
    Seismitoad: { bs: { at: 95 } },
    Sharpedo: { otherFormes: ['Sharpedo-Mega'] },
    Slowbro: { otherFormes: ['Slowbro-Mega'] },
    Snubbull: { types: ['Fairy'] },
    Staraptor: { bs: { sd: 60 } },
    Steelix: { otherFormes: ['Steelix-Mega-Steel', 'Steelix-Mega-Fire'] },
    Stoutland: { bs: { at: 110 } },
    Swampert: { otherFormes: ['Swampert-Mega'] },
    Togekiss: { types: ['Fairy', 'Flying'] },
    Togepi: { types: ['Fairy'] },
    Togetic: { types: ['Fairy', 'Flying'] },
    Tyranitar: { otherFormes: ['Tyranitar-Mega', 'Tyranitar-Armor'] },
    Unfezant: { bs: { at: 115 } },
    Venusaur: { otherFormes: ['Venusaur-Mega', 'Venusaur-Delta', 'Venusaur-Delta-Mega'] },
    Victreebel: { bs: { sd: 70 } },
    Vileplume: { bs: { sa: 110 } },
    Whimsicott: { types: ['Grass', 'Fairy'] },
    Wigglytuff: { types: ['Normal', 'Fairy'], bs: { sa: 85 } },
    Bulbasaur: { otherFormes: ['Bulbasaur-Delta'] },
    Ivysaur: { otherFormes: ['Ivysaur-Delta'] },
    Charmander: { otherFormes: ['Charmander-Delta'] },
    Charmeleon: { otherFormes: ['Charmeleon-Delta'] },
    Squirtle: { otherFormes: ['Squirtle-Delta'] },
    Wartortle: { otherFormes: ['Wartortle-Delta'] },
    Pawniard: { otherFormes: ['Pawniard-Delta'] },
    Bisharp: { otherFormes: ['Bisharp-Mega', 'Bisharp-Delta', 'Bisharp-Delta-Mega'] },
    Sunkern: { otherFormes: ['Sunkern-Delta'] },
    Scyther: { otherFormes: ['Scyther-Delta'] },
    Scraggy: { otherFormes: ['Scraggy-Delta'] },
    Scrafty: { otherFormes: ['Scrafty-Delta'] },
    Combee: { otherFormes: ['Combee-Delta'] },
    Vespiquen: { otherFormes: ['Vespiquen-Delta'] },
    Koffing: { otherFormes: ['Koffing-Delta'] },
    Weezing: { otherFormes: ['Weezing-Delta'] },
    Purrloin: { otherFormes: ['Purrloin-Delta'] },
    Liepard: { otherFormes: ['Liepard-Delta'] },
    Snorunt: { otherFormes: ['Snorunt-Delta'] },
    Froslass: { otherFormes: ['Froslass-Mega', 'Froslass-Delta', 'Froslass-Delta-Mega'] },
    Shinx: { otherFormes: ['Shinx-Delta'] },
    Luxio: { otherFormes: ['Luxio-Delta'] },
    Luxray: { otherFormes: ['Luxray-Delta'] },
    Budew: { otherFormes: ['Budew-Delta'] },
    Roselia: { otherFormes: ['Roselia-Delta'] },
    Drifloon: { otherFormes: ['Drifloon-Delta'] },
    Drifblim: { otherFormes: ['Drifblim-Delta'] },
    Grimer: { otherFormes: ['Grimer-Delta'] },
    Muk: { otherFormes: ['Muk-Delta'] },
    Wooper: { otherFormes: ['Wooper-Delta'] },
    Quagsire: { otherFormes: ['Quagsire-Delta'] },
    Munchlax: { otherFormes: ['Munchlax-Delta'] },
    Snorlax: { otherFormes: ['Snorlax-Delta'] },
    Misdreavus: { otherFormes: ['Misdreavus-Delta'] },
    Mismagius: { otherFormes: ['Mismagius-Delta'] },
    Cyndaquil: { otherFormes: ['Cyndaquil-Delta'] },
    Quilava: { otherFormes: ['Quilava-Delta'] },
    Typhlosion: { otherFormes: ['Typhlosion-Mega', 'Typhlosion-Delta', 'Typhlosion-Delta-Mega'] },
    Treecko: { otherFormes: ['Treecko-Delta'] },
    Grovyle: { otherFormes: ['Grovyle-Delta'] },
    Torchic: { otherFormes: ['Torchic-Delta'] },
    Combusken: { otherFormes: ['Combusken-Delta'] },
    Turtwig: { otherFormes: ['Turtwig-Delta'] },
    Grotle: { otherFormes: ['Grotle-Delta'] },
    Torterra: { otherFormes: ['Torterra-Delta'] },
    Snivy: { otherFormes: ['Snivy-Delta'] },
    Servine: { otherFormes: ['Servine-Delta'] },
    Serperior: { otherFormes: ['Serperior-Delta'] },
    Pidgey: { otherFormes: ['Pidgey-Delta'] },
    Pidgeotto: { otherFormes: ['Pidgeotto-Delta'] },
    Diglett: { otherFormes: ['Diglett-Delta'] },
    Dugtrio: { otherFormes: ['Dugtrio-Delta'] },
    Growlithe: { otherFormes: ['Growlithe-Delta'] },
    Arcanine: { otherFormes: ['Arcanine-Delta'] },
    Geodude: { otherFormes: ['Geodude-Delta'] },
    Graveler: { otherFormes: ['Graveler-Delta'] },
    Tentacool: { otherFormes: ['Tentacool-Delta'] },
    Tentacruel: { otherFormes: ['Tentacruel-Delta'] },
    Doduo: { otherFormes: ['Doduo-Delta'] },
    Dodrio: { otherFormes: ['Dodrio-Delta'] },
    Tangela: { otherFormes: ['Tangela-Delta'] },
    Tangrowth: { otherFormes: ['Tangrowth-Delta'] },
    Ditto: { otherFormes: ['Ditto-Delta'] },
    Kabuto: { otherFormes: ['Kabuto-Delta'] },
    Kabutops: { otherFormes: ['Kabutops-Delta'] },
    Dratini: { otherFormes: ['Dratini-Delta'] },
    Dragonair: { otherFormes: ['Dragonair-Delta'] },
    Dragonite: { otherFormes: ['Dragonite-Delta'] },
    Hoothoot: { otherFormes: ['Hoothoot-Delta'] },
    Noctowl: { otherFormes: ['Noctowl-Delta'] },
    Chinchou: { otherFormes: ['Chinchou-Delta'] },
    Lanturn: { otherFormes: ['Lanturn-Delta'] },
    Pichu: { otherFormes: ['Pichu-Delta'] },
    Aipom: { otherFormes: ['Aipom-Delta'] },
    Ambipom: { otherFormes: ['Ambipom-Delta'] },
    Yanma: { otherFormes: ['Yanma-Delta'] },
    Yanmega: { otherFormes: ['Yanmega-Delta'] },
    Girafarig: { otherFormes: ['Girafarig-Mega', 'Girafarig-Delta', 'Girafarig-Delta-Mega'] },
    Dunsparce: { otherFormes: ['Dunsparce-Delta'] },
    Shuckle: { otherFormes: ['Shuckle-Delta'] },
    Remoraid: { otherFormes: ['Remoraid-Delta'] },
    Octillery: { otherFormes: ['Octillery-Delta'] },
    Elekid: { otherFormes: ['Elekid-Delta'] },
    Electabuzz: { otherFormes: ['Electabuzz-Delta'] },
    Electivire: { otherFormes: ['Electivire-Delta'] },
    Magby: { otherFormes: ['Magby-Delta'] },
    Magmar: { otherFormes: ['Magmar-Delta'] },
    Magmortar: { otherFormes: ['Magmortar-Delta'] },
    Lotad: { otherFormes: ['Lotad-Delta'] },
    Lombre: { otherFormes: ['Lombre-Delta'] },
    Ludicolo: { otherFormes: ['Ludicolo-Delta'] },
    Seedot: { otherFormes: ['Seedot-Delta'] },
    Nuzleaf: { otherFormes: ['Nuzleaf-Delta'] },
    Shiftry: { otherFormes: ['Shiftry-Mega', 'Shiftry-Delta'] },
    Aron: { otherFormes: ['Aron-Delta'] },
    Lairon: { otherFormes: ['Lairon-Delta'] },
    Meditite: { otherFormes: ['Meditite-Delta'] },
    Numel: { otherFormes: ['Numel-Delta'] },
    Plusle: { otherFormes: ['Plusle-Delta'] },
    Minun: { otherFormes: ['Minun-Delta'] },
    Wailmer: { otherFormes: ['Wailmer-Delta'] },
    Wailord: { otherFormes: ['Wailord-Delta'] },
    Feebas: { otherFormes: ['Feebas-Delta'] },
    Milotic: { otherFormes: ['Milotic-Mega', 'Milotic-Delta', 'Milotic-Delta-Mega'] },
    Clamperl: { otherFormes: ['Clamperl-Delta'] },
    Huntail: { otherFormes: ['Huntail-Delta'] },
    Gorebyss: { otherFormes: ['Gorebyss-Delta'] },
    Beldum: { otherFormes: ['Beldum-Delta-S', 'Beldum-Delta-R'] },
    Metang: { otherFormes: ['Metang-Delta-S', 'Metang-Delta-R'] },
    Buneary: { otherFormes: ['Buneary-Delta'] },
    Riolu: { otherFormes: ['Riolu-Delta'] },
    Croagunk: { otherFormes: ['Croagunk-Delta'] },
    Toxicroak: { otherFormes: ['Toxicroak-Delta'] },
    Venipede: { otherFormes: ['Venipede-Delta'] },
    Whirlipede: { otherFormes: ['Whirlipede-Delta'] },
    Petilil: { otherFormes: ['Petilil-Delta-W', 'Petilil-Delta-F'] },
    Lilligant: { otherFormes: ['Lilligant-Delta-W', 'Lilligant-Delta-F'] },
    Solosis: { otherFormes: ['Solosis-Delta'] },
    Duosion: { otherFormes: ['Duosion-Delta'] },
    Reuniclus: { otherFormes: ['Reuniclus-Mega', 'Reuniclus-Delta'] },
    Darumaka: { otherFormes: ['Darumaka-Delta'] },
    Darmanitan: { otherFormes: ['Darmanitan-Delta', 'Darmanitan-Zen'] },
    Maractus: { otherFormes: ['Maractus-Delta'] },
    Dwebble: { otherFormes: ['Dwebble-Delta-B', 'Dwebble-Delta-C'] },
    Crustle: { otherFormes: ['Crustle-Delta-B', 'Crustle-Delta-C'] },
    Yamask: { otherFormes: ['Yamask-Delta'] },
    Cofagrigus: { otherFormes: ['Cofagrigus-Delta'] },
    Emolga: { otherFormes: ['Emolga-Delta'] },
    Karrablast: { otherFormes: ['Karrablast-Delta'] },
    Escavalier: { otherFormes: ['Escavalier-Delta'] },
    Foongus: { otherFormes: ['Foongus-Delta'] },
    Amoonguss: { otherFormes: ['Amoonguss-Delta'] },
    Litwick: { otherFormes: ['Litwick-Delta'] },
    Lampent: { otherFormes: ['Lampent-Delta'] },
    Chandelure: { otherFormes: ['Chandelure-Delta'] },
    Axew: { otherFormes: ['Axew-Delta'] },
    Fraxure: { otherFormes: ['Fraxure-Delta'] },
    Haxorus: { otherFormes: ['Haxorus-Mega', 'Haxorus-Delta'] },
    Golett: { otherFormes: ['Golett-Delta'] },
    Golurk: { otherFormes: ['Golurk-Delta'] },
    Heatmor: { otherFormes: ['Heatmor-Delta'] },
    Deino: { otherFormes: ['Deino-Delta'] },
    Zweilous: { otherFormes: ['Zweilous-Delta'] },
    Hydreigon: { otherFormes: ['Hydreigon-Mega', 'Hydreigon-Delta'] },
    Larvesta: { otherFormes: ['Larvesta-Delta'] },
    Volcarona: { otherFormes: ['Volcarona-Delta', 'Volcarona-Delta-Armor'] },
    Regirock: { otherFormes: ['Regirock-Delta'] },
    Regice: { otherFormes: ['Regice-Delta'] },
    Registeel: { otherFormes: ['Registeel-Delta'] },
    Meloetta: { otherFormes: ['Meloetta-Pirouette', 'Meloetta-Delta-Mime', 'Meloetta-Delta-Magic'] },
    ...
    Sunflora: { otherFormes: [
            'Sunflora-Mega-M', 'Sunflora-Mega-F', 'Sunflora-Delta', 'Sunflora-Delta-Mega',
        ] },
    Magcargo: { otherFormes: ['Magcargo-Mega'] },
    Donphan: { otherFormes: ['Donphan-Mega'] },
    Miltank: { otherFormes: ['Miltank-Mega'] },
    Flygon: { otherFormes: ['Flygon-Mega', 'Flygon-Armor'] },
    ...
    Zekrom: { otherFormes: ['Zekrom-Armor'] },
    Arceus: { otherFormes: [
            'Arceus-Bug',
            'Arceus-Dark',
            'Arceus-Dragon',
    ...
    Giratina: { otherFormes: ['Giratina-Origin', 'Giratina-Primal'] },
    ...
    Hoopa: {
        ...
        otherFormes: ['Hoopa-Unbound', 'Hoopa-Delta', 'Hoopa-Delta-Unbound']
    },
    'Hoopa-Unbound': {
        types: ['Psychic', 'Dark'],
...
var SM_PATCH = {
    ...
    Delcatty: { bs: { sp: 90 } },
    Diglett: { otherFormes: ['Diglett-Delta', 'Diglett-Alola'] },
    Dodrio: { bs: { sp: 110 } },
    Dugtrio: { bs: { at: 100 }, otherFormes: ['Dugtrio-Delta', 'Dugtrio-Alola'] },
    Eevee: { otherFormes: ['Eevee-Starter'] },
    Electrode: { bs: { sp: 150 } },
    Exeggutor: { bs: { sd: 75 }, otherFormes: ['Exeggutor-Alola'] },
    'Farfetch\u2019d': { bs: { at: 90 } },
    Gengar: { abilities: { 0: 'Cursed Body' } },
    Geodude: { otherFormes: ['Geodude-Delta', 'Geodude-Alola'] },
    Golem: { otherFormes: ['Golem-Delta', 'Golem-Alola'] },
    Graveler: { otherFormes: ['Graveler-Delta', 'Graveler-Alola'] },
    Greninja: { otherFormes: ['Greninja-Delta', 'Greninja-Ash'] },
    Grimer: { otherFormes: ['Grimer-Delta', 'Grimer-Alola'] },
    Illumise: { bs: { df: 75, sd: 85 } },
    Lunatone: { bs: { hp: 90 } },
    Magcargo: { bs: { hp: 60, sa: 90 } },
    Mantine: { bs: { hp: 85 } },
    Marowak: { otherFormes: ['Marowak-Mega', 'Marowak-Alola', 'Marowak-Alola-Totem'] },
    ...
    Qwilfish: { bs: { df: 85 } },
    Raichu: { otherFormes: ['Raichu-Delta', 'Raichu-Alola'] },
...
var SS_PATCH = {
    ...
    Blastoise: {
        otherFormes: ['Blastoise-Gmax', 'Blastoise-Mega', 'Blastoise-Delta', 'Blastoise-Delta-Mega']
    },
    ...
    Darmanitan: {
        otherFormes: ['Darmanitan-Delta', 'Darmanitan-Galar', 'Darmanitan-Galar-Zen', 'Darmanitan-Zen']
    },
    Darumaka: { otherFormes: ['Darumaka-Delta', 'Darumaka-Galar'] },
    ...
    Snorlax: { otherFormes: ['Snorlax-Gmax', 'Snorlax-Delta'] },
    Stunfisk: { otherFormes: ['Stunfisk-Mega', 'Stunfisk-Galar'] },
    Venusaur: { otherFormes: [
            'Venusaur-Gmax', 'Venusaur-Mega', 'Venusaur-Delta', 'Venusaur-Delta-Mega',
        ] },
    Voodoom: { bs: { sa: 130 } },
    Weezing: { otherFormes: ['Weezing-Delta', 'Weezing-Galar'] },
    Yamask: { otherFormes: ['Yamask-Delta', 'Yamask-Galar'] },
